...
# Spectral Data
In the [`spectral-data` folder](https://github.com/NanoCalc/RICalc/tree/main/Spectral%20Data), you will find additional data that can be used to obtain the refractive index of different materials.
