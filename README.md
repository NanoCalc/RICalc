...
# Spectral Data
In the [`spectral-data` folder](https://github.com/NanoCalc/RICalc/tree/main/spectral-data), you will find additional data that can be used to obtain the refractive index of different materials.
